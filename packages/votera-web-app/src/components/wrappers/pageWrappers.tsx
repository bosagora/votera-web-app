import {HeaderPage, HeaderPageProps} from 'votera-ui-components';
...
const HeaderContainer = styled.div.attrs({
  className:
    'col-span-full desktop:col-start-2 desktop:col-end-12 -mx-2 tablet:mx-0 tablet:mt-2 desktop:mt-2',
})``;
