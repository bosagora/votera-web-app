...
This package contains the building block for the Zaragoza web-app. It is directly based on Votera's design system.
...
| Label | Release type |
| ------ | ------------ |
| `votera-ui-components:major` | `major` |
| `votera-ui-components:minor` | `minor` |
| `votera-ui-components:patch` | `patch` |
...
`MAJOR.MINOR.PATCH-votera-ui-components`
